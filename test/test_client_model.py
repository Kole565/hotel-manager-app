...
class TestClientModel(unittest.TestCase):
    ...
    def test_save_load(self):
        ...
        loaded_test_object = ClientModel.from_table(*self.objects_list(db)[-1])

        self.assertEqual(test_object.password_hash, loaded_test_object.password_hash)
        self.assertEqual(test_object.username, loaded_test_object.username)
        self.assertEqual(test_object.name, loaded_test_object.name)
        self.assertEqual(test_object.credentials, loaded_test_object.credentials)
